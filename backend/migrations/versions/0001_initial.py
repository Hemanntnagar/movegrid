...
def upgrade():
    op.create_table("users", sa.Column("id", sa.Integer(), primary_key=True), sa.Column("email", sa.String(255), nullable=False, unique=True), sa.Column("full_name", sa.String(120), nullable=False), sa.Column("password_hash", sa.String(255), nullable=False), sa.Column("move_points", sa.Integer(), server_default="0"), sa.Column("streak", sa.Integer(), server_default="0"), sa.Column("is_admin", sa.Boolean(), server_default=sa.false()))
